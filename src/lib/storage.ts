...
export const SAMPLE_WATCHLIST: WatchlistEntry[] = [
  ...
  },
  {
    ...
    status: 'watching',
    priority: 'medium',
    audience: 'partner1', // Solo Partner 1
    addedBy: 'Player 1',
    partner1Rating: 9,
    partner2Rating: null,
    partner1Interest: 'hyped',
    partner2Interest: 'pass', // Partner 2 passed, so it moved to P1 solo!
  ...
  },
  {
    ...
    status: 'watching', // Playing together
    priority: 'high',
    audience: 'together',
    addedBy: 'Player 2',
  ...
  },
  {
    ...
    status: 'watching',
    priority: 'high',
    audience: 'partner2', // Solo Partner 2
    addedBy: 'Player 2',
  ...
  },
  {
    ...
    status: 'watchlist', // To Read
    priority: 'high',
    audience: 'together', // Shared Book Club!
    addedBy: 'Player 1',
  ...
  },
  {
    ...
    status: 'watched', // Finished reading
    priority: 'low',
    audience: 'partner1', // Solo Partner 1
    addedBy: 'Player 1',
